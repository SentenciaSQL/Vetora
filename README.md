...
- Branding dinámico: `GET /api/v1/settings/branding` (sesión) y `GET /api/v1/public/tenants/{slug}/branding` (login de clínica). Si no hay logo, Angular y Flutter muestran la marca Animexa.
